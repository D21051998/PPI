...
public List<Record> getStudents(){
	...
	public static List<Skills> getSkills(){
        ...
        try{
        	connection = ConnectionFactory.getConnection();
            PreparedStatement ps = connection.prepareStatement("select * from attitude");
            rs = ps.executeQuery();
            while(rs.next()){
            	Skills s =new Skills();
	...
	public static Remarks getRemarksById(String id){
        ...
        try{
        	connection = ConnectionFactory.getConnection();
            PreparedStatement ps = connection.prepareStatement("select * from remarks where id=?");
            ps.setString(1, id);
            rs = ps.executeQuery();
            if(rs.next()){
            	r.setRoll(rs.getString(1));
	...
	public static void addRemarks(String id,String remark){
        ...
        try{
        	connection = ConnectionFactory.getConnection();
            PreparedStatement ps = connection.prepareStatement("insert into remarks values(?,?)");
	...
	public static void updateKnowledge(String id,String ds, String log,String cao,String dbms,String os, String cn, String app){
        ...
        try{
        	connection = ConnectionFactory.getConnection();
            PreparedStatement ps = connection.prepareStatement("update knowledge set data_structure=?,"
	...
	public static void updateSkills(String id,String team,String enth,String conf,String clean,String oral,String lang,String prob,String skill){
        ...
        try{
        	connection = ConnectionFactory.getConnection();
            PreparedStatement ps = connection.prepareStatement("update attitude set team_spirit=?,enthusiasm=?,self_conf=?"
	...
	public static void updateRemarks(String id,String remark){
        ...
        try{
        	connection = ConnectionFactory.getConnection();
            PreparedStatement ps = connection.prepareStatement("update remarks set remarks=? where id=?");
