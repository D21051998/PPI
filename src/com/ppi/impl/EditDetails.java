...
public class EditDetails extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try{
	        ...
	        RecordsIMPL.updateKnowledge(rno, data, logic, cao, dbms, os, cn, app);
	        RecordsIMPL.updateSkills(rno, team, enth, conf, clean, oral, lang, prob, skill);
	        RecordsIMPL.updateRemarks(rno, remarks);
